...
#
# ollama.py - Lógica para realizar las peticiones al modelo LLM y clasificar los resultados en MISP
...
def crear_evento_misp(url, contenido, criticidad):
    ...
    if tag_info is None:
        print(f"Criticidad desconocida '{criticidad}' para la URL: {url}. No se creará un evento.")
        return
    tag = tag_info["name"]
